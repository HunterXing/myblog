...
<div class="table-box">
    <table>
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td class="operate">
                    <a href ='javascript:;' class="show" data="<?php echo ($vo["id"]); ?>" data-title="<?php echo ($vo["title"]); ?>" data-content="<?php echo ($vo["content"]); ?>">查看</a>|
                    <a href ='/index.php/Admin/Email/edit/id/<?php echo ($vol["id"]); ?>' >编辑</a>
                </td>
