...
<div id="container">
      ...
      <div class="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="email">
            ...
            <ul class="subnav">
              <li><a href="javascript:;" date-src="info-reg.html">发邮件</a></li>
              <li><a href="javascript:;" date-src="info-mgt.html">发件箱</a></li>
              <li><a href="javascript:;" date-src="info-det.html">收件箱</a></li>
            </ul>
          </li>
          <li class="system">
  ...
  <div id="ft" class="ue-clear">
    <div class="ft-left"> <span>练习项目</span> <em>Office&nbsp;System</em> </div>
    <div class="ft-right"> <span>Automation</span> <em>V2.0&nbsp;2018</em> </div>
  </div>
</div>
